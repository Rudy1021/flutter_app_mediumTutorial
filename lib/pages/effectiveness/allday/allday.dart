...
class EffectAlldayPage extends StatefulWidget {
  const EffectAlldayPage({Key? key}) : super(key: key);

  @override
  State<EffectAlldayPage> createState() => _EffectAlldayPageState();
}

class _EffectAlldayPageState extends State<EffectAlldayPage> {
  @override
